    ...
    <div className="p-4 flex flex-col gap-2.5 md:max-w-[60%] mt-20 mx-auto">
      {items.length === 0 ? (
        ...
        <ul className="flex flex-col gap-2.5">
          {items.map((item, index) => (
            <section
              key={index}
              className="bg-white antialiased dark:bg-gray-900"
            >
              <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 md:p-6">
                <div className="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                  ...
                  <div className="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md flex flex-col gap-1.5">
                    <a className="text-base font-medium text-gray-900 hover:underline dark:text-white m-0">
                      {item.name}
                    </a>
                    <a className="text-base font-normal text-gray-900 hover:underline dark:text-white m-0">
                      {item.description}
                    </a>
      ...
      <div className="w-full mt-6 flex-1 space-y-6 lg:mt-0 lg:w-full">
        <div className="space-y-4 rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6">
          ...
          <a className="flex w-full items-center justify-center rounded-lg bg-primary-700 cursor-pointer px-5 py-2.5 text-sm font-medium text-white hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 bg-green-700">
            Proceed to Checkout
          </a>
        </div>
      </div>
