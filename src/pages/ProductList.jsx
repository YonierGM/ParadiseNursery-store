...
function ProductList() {
  ...
  return (
    <>
      <section className="p-2.5 flex flex-col items-center gap-3.5 mt-24">
        {plantsArray.map((item, categoryIndex) => (
          <div key={categoryIndex}>
            <div className="category flex flex-col gap-1 mb-3.5 items-center">
              <hr className="border border-gray-100 w-xs" />
            ...
            <div
              key={categoryIndex} // Clave única para cada categoría
              className="products flex flex-row flex-wrap justify-center gap-3.5"
            >
